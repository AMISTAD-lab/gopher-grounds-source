...
# vis.createAnnotatedTrap(Encoding(), save=True, show=False, indexes=True, output='annotated_trap')
# vis.createAnnotatedTrap(encoder, save=True, show=False, indexes=True, output='annotated_trap_enc')
# orange = (255, 174, 85)
# point_list = [
#         ((0, 3), (0, 0)), ((0, 0), (2, 0)),
#         ((2, 0), (2, 3)), ((2, 3), (1, 3)),
...
# vis.createArrowTrap(encoder, point_list, save=True, show=False, text_color='white', arrow_color='red', output='arrowed_trap_enc')
# vis.createSplitTrap(5, Encoding(), annotate=True, save=True, show=False, output='split_trap')
# vis.createSplitTrap(5, encoder, annotate=True, save=True, show=False, output='split_trap_new')
